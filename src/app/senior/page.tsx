  ...
  return (
    <PageTransition>
      ...
      <div className="px-5 pt-8 pb-2 safe-top">
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-[var(--text-primary)] mt-1">联系小羊学姐</h1>
      </div>
      ...
      <section className="px-5 mt-6 mb-8 space-y-4">
        ...
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, #f093fb 0%, #f5576c 50%, #fee140 100%)" }}
        >
          ...
          <div className="relative z-10">
            ...
            <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-4">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="text-xs text-white/70">微信号</p>
              </div>
              <p className="text-xl font-mono font-bold tracking-wider mb-3">{wechatId}</p>
              <CopyButton
                text={wechatId}
                label="复制微信号"
                successMessage="微信号已复制，请打开微信搜索添加"
